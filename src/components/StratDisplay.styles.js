...
export const CurrentTeamDisplay = styled.span`
    padding: 5px;
    margin-left: 5px;
    color: ${ props => props.currentTeam === TeamConstants.offense? "white" : "white" } /* This is redundant but placeholder for decision on background colors*/
    background-color: ${ props => props.currentTeam === TeamConstants.offense? "darkred" : "darkblue" }
`;
