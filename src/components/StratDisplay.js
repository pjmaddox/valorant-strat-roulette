...
import { StratDisplayContainer, StratDisplayDiv, StratDisplayDivInner, StratDisplaySpacer, CurrentTeamDisplay, CurrentMapLabel } from './StratDisplay.styles'
import { ButtonContainer, ButtonContainerInner } from "./ButtonContainer.styles";
import { LogoContainer } from "./LogoContainer.styles";
import { NewStratButton } from "./CustomButton.styles";
import StratDescription from "./StratDescription";
import StratTitle from "./StratTitle";
import TeamConstants from "../constants/TeamConstants";
import MapSelection from "../components/MapSelection";
import { getMapLoadingScreen } from '../constants/MapConstants';
...
const StratDisplay = ({stratData, team, changeStratFunction, changeTeam, map, changeCurrentMap}) => {
    ...
    return (
        <StratDisplayContainer >
            ...
            <StratDisplayDiv
                style={{
                    backgroundImage: `linear-gradient(var(--red), ${red}99), url(${backgroundImage})`,
                }
            }>
                <StratDisplayDivInner>
            ...
            <StratDisplaySpacer></StratDisplaySpacer>
        </StratDisplayContainer>
    );
};
